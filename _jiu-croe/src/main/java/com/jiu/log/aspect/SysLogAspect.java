...
import com.jiu.context.ThreadLocalParam;
...
import com.jiu.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     * 用于SpEL表达式解析.
     */
    private SpelExpressionParser SPEL_EXPRESSION_PARSER = new SpelExpressionParser();
    /**
     * 用于获取方法参数定义名字.
     */
     ...
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.jiu.base.controller.*.*(..)) || @annotation(com.jiu.log.annotation.SysLog)")
