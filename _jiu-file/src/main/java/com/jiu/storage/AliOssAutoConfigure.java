...
import com.jiu.strategy.impl.AbstractFileChunkStrategy;
import com.jiu.strategy.impl.AbstractFileStrategy;
...
import static com.jiu.utils.DateUtils.DEFAULT_MONTH_FORMAT_SLASH;
...
@Configuration
@Slf4j
@ConditionalOnProperty(name = "jiu.file.type", havingValue = "ALI")
